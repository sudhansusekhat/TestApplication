...
public class ItemListAdapter extends RecyclerView.Adapter<ItemListAdapter.MyViewHolder> {
    ...
    ArrayList<ItemList.lstItemList> model;
    private Activity mContext;

    public ItemListAdapter(Activity mContext,  ArrayList<ItemList.lstItemList> model) {
        this.model = model;
...
//        }
        ...
        holder.txt_name.setText(model.get(position).ICC);
        holder.txt_detail.setText(model.get(position).IDE);
